...
#define luaL_dobuffer(L, buff, size, name)	(luaL_loadbuffer(L, buff, size, name) || lua_pcall(L, 0, 0, 0))
#define luaL_dowbuffer(L, buff, size, name)	(luaL_loadwbuffer(L, buff, size, name) || lua_pcall(L, 0, 0, 0))
