...
#define lua_assert(o)	{ (void)o; assert(o); }
#else
...
#define luai_userstateclose(L)		LuaState_UserStateFree(L)
//#define luai_userstatethread(L,L1)	((void)L)
#define luai_userstatethread(L,L1)	LuaState_UserStateThread(L, L1)
//#define luai_userstatefree(L)		((void)L)
#define luai_userstatefree(L)		LuaState_UserStateFree(L)
