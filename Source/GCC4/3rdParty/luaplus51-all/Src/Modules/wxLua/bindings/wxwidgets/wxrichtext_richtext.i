...
%class %delete wxTextAttrEx, wxTextAttr
...
%class %delete wxRichTextObject, wxObject
...
%class %delete wxRichTextBox, wxRichTextCompositeObject
...
%class %delete wxRichTextParagraphLayoutBox, wxRichTextBox
...
%class %delete wxRichTextParagraph, wxRichTextBox
...
%class %delete wxRichTextPlainText, wxRichTextObject
...
%class %delete wxRichTextImageBlock, wxObject
...
%class %delete wxRichTextImage, wxRichTextObject
...
%class %delete wxRichTextBuffer, wxRichTextParagraphLayoutBox
...
%class %delete wxRichTextCommand, wxCommand
...
%class %delete wxRichTextAction, wxObject
...
%class %delete wxRichTextFileHandler, wxObject
...
%class %delete wxRichTextPlainTextHandler, wxRichTextFileHandler
...
%class %delete wxRichTextBufferDataObject, wxDataObjectSimple
...
%class %delete wxRichTextRenderer, wxObject
    //wxRichTextRenderer() {}
...
%class %delete wxRichTextStdRenderer, wxRichTextRenderer
