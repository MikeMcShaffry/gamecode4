...
output_cpp_header_filepath = wxlua_dir.."modules/wxluasocket/include"
output_cpp_filepath        = wxlua_dir.."modules/wxluasocket/src"
...
hook_cpp_header_filename = "wxluasocket/include/"..hook_cpp_namespace.."_bind.h"
