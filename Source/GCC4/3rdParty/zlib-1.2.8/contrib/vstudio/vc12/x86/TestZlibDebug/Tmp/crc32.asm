; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.31101.0 
	...
	TITLE	D:\ProjectsGit\gamecode4\Source\GCC4\3rdParty\zlib-1.2.8\crc32.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File d:\projectsgit\gamecode4\source\gcc4\3rdparty\zlib-1.2.8\crc32.c
...
; 393  :         if (len2 == 0)
	...
	mov	eax, DWORD PTR _len2$[ebp]
	or	eax, DWORD PTR _len2$[ebp+4]
	jne	SHORT $LN2@crc32_comb
...
; 398  :         if (len2 & 1)
	...
	mov	DWORD PTR tv172[ebp+4], ecx
	mov	edx, DWORD PTR tv172[ebp]
	or	edx, DWORD PTR tv172[ebp+4]
	je	SHORT $LN1@crc32_comb
...
; 334  :     while (vec) {
	...
	je	SHORT $LN2@gf2_matrix

; 335  :         if (vec & 1)

	mov	eax, DWORD PTR _vec$[ebp]
	and	eax, 1
	je	SHORT $LN1@gf2_matrix
...
; 221  :         if (*((unsigned char *)(&endian)))
	...
	movzx	eax, BYTE PTR _endian$1[ebp]
	test	eax, eax
	je	SHORT $LN8@crc32
